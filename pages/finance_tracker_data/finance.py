...
class PersonalFinance:
    ...
    def plot_expenses(self, value):
        ...
        if value == "date":
            ...
            dummy_df = (
                df.groupby(["month_year", "item_category"])["price"].sum().reset_index()
            )
            ...
            monthly_spending_df = (
                df.groupby(["month_year"])["price"].sum().reset_index()
            )
    ...
    def find_max(self, category):
        ...
        return (
            final_df["item_name"].iloc[0],
            final_df["price"].iloc[0],
            final_df["date"].iloc[0],
        )
    ...
    def plot_treemap(self):
        ...
        fig = px.treemap(
            dummy_df,
            path=[px.Constant("total spending"), "item_name"],
